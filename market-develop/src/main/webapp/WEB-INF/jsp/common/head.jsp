        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="${pageContext.request.contextPath }/staff/flatform/main" class="site_title"><i
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> 进货管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/staff/flatform/ckin/getall">进货信息</a>
                                    </li>
                                    <li><a href="${pageContext.request.contextPath }/staff/flatform/ckretire/getall">退货信息</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-edit"></i> 商品信息管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="${pageContext.request.contextPath }/staff/flatform/product/getlist">商品信息</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath }/staff/flatform/type/getall">商品类别</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-desktop"></i> 库存管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/staff/flatform/kcxx/getall">库存信息</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath }/staff/flatform/kcxx/kcxxWithPronum">库存预警</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath }/staff/flatform/kcxx/kcxxWithProdata">临期产品</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li><a><i class="fa fa-bar-chart-o"></i> 客户信息管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/staff/flatform/custom/getall">客户信息</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-clone"></i>供应商信息管理 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/staff/flatform/supply/getall">供应商信息</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                ...
                                <span class="glyphicon glyphicon-user" style="display:none"
                                      id="staffid">${staffSession.staffid}</span>
                            ...
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                ...
                                <li><a href="${pageContext.request.contextPath }/staff/logout"><i
