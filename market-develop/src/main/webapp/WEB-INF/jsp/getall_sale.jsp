                ...
                <form class="form-inline" action="getbyparams" method="post">
                    ...
                    <span class="row">
								 ...
								 <div class="form-group" class="col-xs-1">
								  ...
								  <a href="${pageContext.request.contextPath }/staff/flatform/sale/toadd"
                        ...
                        <c:forEach items="${pageInfo.list}" var="sale">
                            <tr>
                                ...
                                <th>
                                    ...
                                    <a href="${pageContext.request.contextPath }/staff/flatform/sale/getbyid?saleid=${sale.saleid}"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath }/staff/flatform/sale/getall?pn=1">首页</a>
                            </li>
                            <c:if test="${pageInfo.hasPreviousPage }">
                                <li>
                                    <a href="${pageContext.request.contextPath }/staff/flatform/sale/getall?pn=${pageInfo.pageNum-1}"
                            ...
                            <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                ...
                                <c:if test="${page_Num != pageInfo.pageNum }">
                                    <li>
                                        <a href="${pageContext.request.contextPath }/staff/flatform/sale/getall?pn=${page_Num }">${page_Num }</a>
                                    </li>
                                </c:if>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath }/staff/flatform/sale/getall?pn=${pageInfo.pages}">末页</a>
                            </li>
                        </ul>
                    </nav>
                </div>
