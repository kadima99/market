        ...
        <div class="animate form login_form">
            <section class="login_content">
                <form action="dologin" method="post">
                    ...
                    <img src="${pageContext.request.contextPath }/manager/checkCode" alt="" width="100" height="32" style="height:43px;cursor:pointer;margin:10px" onclick="this.src=this.src+'?'">
